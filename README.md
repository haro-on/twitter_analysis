...
The objective of this project is to do a wrangling, analyzing then visualizing of @dog_rates tweets.  
...
Second, I will assess the data of its quality and tidiness, then clean it.  
Last, I will do some analysis and visulization on the dataset.
